# KN-Space webapp — quy tắc làm việc

Các quy tắc dưới đây áp dụng khi Claude Code làm việc trong thư mục `webapp/` (React + Vite + TypeScript + Supabase), bất kể chạy trên máy nào. File này được commit vào git để mọi máy `git pull` về đều có cùng ngữ cảnh.
